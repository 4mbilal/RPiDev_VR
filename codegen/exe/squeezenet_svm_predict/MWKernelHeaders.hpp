...
void __global__ YoloReorg2dImpl(float*,
                                ...
                                int,
                                int,
                                const long int BRSPqxNffoBYKqpSVHne);
...
void __global__ scale_vector_kernel(float*, float*, float*, long int, long int, long int);

void __global__
scale_matrix2d_kernel(float*, float*, float*, long int, long int, long int, long int);

void __global__
scale_tensor3d_kernel(float*, float*, float*, long int, long int, long int, long int, long int);

void __global__ offset_scalar_kernel(float*, float*, float*, long int, bool, int, int);

void __global__
offset_vector_kernel(float*, float*, float*, long int, long int, long int, bool, int, int);
...
/* LSTM kernel Impl */
void __global__ expand_batch_kernel(float*, float*,
                                    long int, long int);
void __global__ interleave_bilstm_passes(float*, float*,
...
void __global__ wordEmbedding_kernel_vocab(const float*, float*, const int, const int);
